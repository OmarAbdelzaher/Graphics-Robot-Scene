...
static int shoulderRx = -80, elbowR = 0, fingerBaseR = 0, fingerUpR = 0, footRx = 0,footRz = 0;
static int shoulderLx = 80, elbowL = 0, fingerBaseL = 0 , fingerUpL = 0, footLx = 0,footLz = 0;
...
float x_position_1 = 0.0;
float x_position_2 = 0.0;
float x_position_3 = 0.0;
float y_position = 0.0;
float z_position = 0.0;
float z_position_1 = 0.0;
float z_position_2 = 0.0;
float z_position_3 = 0.0;
int state = 1;
